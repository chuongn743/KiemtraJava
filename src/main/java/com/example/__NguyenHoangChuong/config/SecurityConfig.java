package com.example.__NguyenHoangChuong.config;

import com.example.__NguyenHoangChuong.service.UserService;
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/phong-ban/update/**", "/phong-ban/add", "/phong-ban/delete")
